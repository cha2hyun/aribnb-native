...
export default ({ navigation }) => {
    ...
    return (
        <Container>
            <BlurView intensity={30} tint="light" style={{ flex: 1, width: "100%", alignItems: "center", justifyContent: "center" }}>
            ...
            <Image resizeMethod="auto" source={require("../../assets/loginBg.jpeg")} />
